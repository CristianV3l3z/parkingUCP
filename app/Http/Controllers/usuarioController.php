...
class usuarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // La validación en formato de string está correcta: 'unique:tabla,columna'
    ...
    public function register(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'correo' => [
                'required',
                'email', // <-- CORREGIDO: Usar 'email' para validar el formato. Antes decía 'correo' (regla inexistente)
                'max:150',
        ...
        $usuario = Usuario::create([
            ...
            // <-- CORREGIDO: Usar $validated['correo'] que es el nombre correcto de la clave
    ...
    public function login(Request $request)
    {
        ...
        $vigilanteCtrl = app()->make(\App\Http\Controllers\vigilanteController::class); // Corregida la referencia
